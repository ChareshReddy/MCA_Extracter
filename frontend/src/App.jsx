    ...
    <div className="app-root">
      ...
      <main className="dashboard-main">
        ...
        <aside className="sidebar">
          {/* Input File Section */}
          <section className="glass-panel animate-in" style={{ display: 'flex', flexDirection: 'column', padding: '0.75rem 1rem' }}>
            ...
            <div className="input-group" style={{ marginBottom: '0.75rem' }}>
              <label className="label-text" style={{ fontSize: '0.7rem' }}>Select Input Excel File</label>
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button className="btn-base" 
                        style={{ padding: '0.4rem 0.6rem', fontSize: '0.8rem', background: 'var(--panel-hover)', border: '1px solid var(--border-dim)', color: 'white' }}
                        onClick={handleInputBrowse}
                        disabled={status.is_running}>
                  <FolderOpen size={16} />
                  Choose File
                </button>
                <div className="file-display" style={{ padding: '0.4rem 0.6rem' }} title={inputPath ? inputPath.split(/[/\\]/).pop() : ""}>
                  <span className="file-name" style={{ fontSize: '0.8rem' }}>{inputPath ? inputPath.split(/[/\\]/).pop() : "No file selected..."}</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  ...
                  <span style={{ fontSize: '0.6rem', color: 'var(--text-dim)', fontWeight: '600', textTransform: 'uppercase' }}>Total Records</span>
                </div>
                <div style={{ fontSize: '1rem', fontWeight: 'bold', color: totalRecords > 0 ? 'var(--text-main)' : 'var(--text-dim)', paddingLeft: '1.4rem' }}>
                  {totalRecords || "0"}
                </div>
              </div>
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  ...
                  <span style={{ fontSize: '0.6rem', color: 'var(--text-dim)', fontWeight: '600', textTransform: 'uppercase' }}>Records Pending</span>
                </div>
                <div style={{ fontSize: '1rem', fontWeight: 'bold', color: pendingRecords > 0 ? 'var(--warning-orange)' : 'var(--text-dim)', paddingLeft: '1.4rem' }}>
                  {pendingRecords || "0"}
                </div>
              </div>
            </div>
